...
title: Hello
 feature_text: |
  ## TissUUmaps
  Browser-based interactive visualization of multi-omics data
feature_image: "http://user.it.uu.se/~cli05194/pics/map.png"
...
[comment]: # (Alembic is a starting point for [Jekyll](https://jekyllrb.com/) projects. Rather than starting from scratch, this boilerplate is designed to get rolling immediately. Install it, configure it, tweak it, push it.)
